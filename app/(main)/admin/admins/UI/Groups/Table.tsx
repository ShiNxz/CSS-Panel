	...
	const renderCell = (item: SA_AdminGroup, columnKey: any) => {
		switch (columnKey) {
			...
			case 'flags':
				...
				const webFlags = flags.filter((flag) => flag.startsWith('@web'))
				const cssFlags = flags.filter((flag) => flag.startsWith('@css'))
